    ...
    <>
      <div className="main">
        ...
        <div className="budget">
          <p className="budget_sub">BUDGET</p>
        </div>
        <div className="metrics">
          <p className="metrics_sub">METRICS</p>
        </div>
      </div>
      <div className="sub">
        <div>
          <div className="box1">
            ...
            <div className="subbox1">
              ...
              <div className="ma">Ma...</div>
            </div>
            <div className="last">Last 30 Days</div>
            <div className="view">View milestone</div>
          </div>

          <div className="box2">
            <div className="primary">
              <p className="sub_primary">Primary Metrics</p>
            </div>
            <div>
